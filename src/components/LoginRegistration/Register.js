...
const Register = () => {
    ...
    const doRegister = async (event) => {
        ...
        const {data} = await axios.post('https://camping-gears-server.onrender.com/login', {email});
        console.log(data);
    ...
    return (
        <div className='text-white font-[poppins] flex flex-col md:flex-row items-center md:justify-between mb-10'>
            ...
            <div className='mr-10 w-3/4'>
                <h2 className='text-orange-400 text-center text-xl font-medium mt-10 mb-5'>Register Here</h2>
                <form onSubmit={doRegister} className='grid grid-rows-4 gap-4'>
                    ...
                    <div className='items-center'>
                        <button disabled={!agree} className='pt-3 pb-3 pl-4 pr-4 w-52 rounded bg-orange-600 hover:bg-orange-700 mb-5' data-mdb-ripple="true" data-mdb-ripple-color="light">Register</button>
                    </div>
                </form>
                {errorOccured}
